...
const Category = {
  ...
  create: (category, callback) => {
    ...
    const sql = `INSERT INTO category (cid,label, sublabel, icon, description, colorcode, createdOn) VALUES (?, ?, ?, ?, ?, ?, ?)`;

    db.query(sql, [cid,label, sublabel, icon, description, colorcode, createdOn], (err, result) => {
