...
@ViewChild('deleteCategory') deleteCategoryModal:any
...
confirmDelete(data:any){
  ...
  this.modalServices.open(this.deleteCategoryModal,{centered:true})
}
...
removeCategory()
{
  if(this.categoryDelete?.cid){
    this.categorySerices.deleteCategory(this.categoryDelete.cid).subscribe((data)=>{
      this.cancelCategory();
      this.getAllCategories();
    })
  }
